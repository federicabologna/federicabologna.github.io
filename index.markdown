...
1. **<u>Advancing evaluation of clinical AI</u>**: I developed [VERT](https://arxiv.org/abs/2604.03376), an LLM-based metric for the assessment of radiology reports, with [Jean-Philippe Corbeil](https://scholar.google.com/citations?user=eqlyHDsAAAAJ&hl=fr) and [Asma Ben Abacha](https://scholar.google.com/citations?user=KO6_r0cAAAAJ&hl=en). I created [the CQA-Eval framework](https://arxiv.org/abs/2510.10415) for the evaluation of multi-paragraph model-generated answers to consumer health questions with [Lucy Lu Wang](https://www.llwang.net/) and [Yue Guo](https://yueguo-50.github.io/). At [NYC Health + Hospitals](https://www.nychealthandhospitals.org/), I demonstrated that revising alert criteria can reduce unnecessary alerts by up to 94%, while improving alert design can decrease overridden alerts by up to 64%.

2. **<u>Improving scientific question answering AI</u>**: at [the Allen Institute for Artificial Intelligence (Ai2)](https://allenai.org/) under the guidance of [Jay DeYoung](https://scholar.google.com/citations?user=f8aP6RMAAAAJ&hl=en) I’ve built a system that suggests reformulated queries to users to assist them with finding the desired information. Our system increases increases the recall of scientific information in the output of the [Asta](https://asta.allen.ai/chat) AI research assistant by 50%.
